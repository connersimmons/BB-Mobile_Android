...
import me.connersimmons.bb_mobile.utils.AndroidCustomField;
import me.connersimmons.bb_mobile.utils.DataMappings;
...
public class ContactAPI {
    ...
    public ContactAPI(Context context, String accountName, String accountType) {
    ...
    public static boolean insertContact(ContentResolver contactAdder, VCard vcard) { // String firstName, String mobileNumber) {
