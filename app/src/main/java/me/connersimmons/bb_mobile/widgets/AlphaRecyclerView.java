package me.connersimmons.bb_mobile.widgets;
...
import me.connersimmons.bb_mobile.utils.Util;
...
public class AlphaRecyclerView extends RecyclerView {
    ...
    public AlphaRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public AlphaRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
