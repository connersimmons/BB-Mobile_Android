...
import me.connersimmons.bb_mobile.widgets.adapters.VendorsAlphaViewAdapter;
import me.connersimmons.bb_mobile.models.Contact;
import me.connersimmons.bb_mobile.fragments.BaseDecorationFragment;

/**
 * Created by connersimmons on 2/4/16.
 */
public class VendorsAlphaFragmentOld extends BaseDecorationFragment implements RecyclerView.OnItemTouchListener {

    private static final String TAG = VendorsAlphaFragmentOld.class.getName();
    ...
    public VendorsAlphaFragmentOld() {
